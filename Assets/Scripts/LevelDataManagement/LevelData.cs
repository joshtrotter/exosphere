...
public class LevelData {
	...
	public string GetGoldenBallFoundAsString(){
		return NoDeathsChallengeHasBeenCompleted() ? "Found" : "Not Found";
	}
	...
	public int GetStarsEarned(){
		...
		if (AllCollectablesHaveBeenCollected())
			starsEarned += 1;
		if (NoDeathsChallengeHasBeenCompleted())
			starsEarned += 1;
		return starsEarned;
	}
	...
	public void SetNoDeathsCompleted(){
		saveData.noDeathsCompleted = true;
	}
